package estacionamento.security;
...
public class JWTManager implements Serializable {
    ...
    public JWTManager() throws JoseException {
        if (appConfig.getChave() == null) {
            ...
            Logger.getLogger(JWTManager.class.getName()).log(Level.WARNING, "Coloque os parametros no estacionamento.properties e reinicie a app ");
