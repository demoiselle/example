...
module.exports = (function () {
  ...
  config.plugins = [
    ...
    new webpack.DefinePlugin({
      ...
      'process.env': {
        ...
        CONF:
        isProd ?
          JSON.stringify(require('./config/webpack.prod')) :
          isTest ?
            JSON.stringify(require('./config/webpack.test')) :
            JSON.stringify(require('./config/webpack.dev'))
  ...
  config.sassLoader = {
    ...
    includePaths: [path.resolve(__dirname, "node_modules/angular2-mdl/scss")]
  };
