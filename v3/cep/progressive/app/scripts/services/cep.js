...
app.factory('CepService', ['$http', function ($http) {
        ...
        service.getMunicipios = function (uf) {
            return $http.get('https://cep-fwkdemoiselle.rhcloud.com/api/v1/cidades/' + uf).then(function (res) {
                return res;
            });
        };

        service.getLogradouro = function (uf, logra) {
            return $http.get('https://cep-fwkdemoiselle.rhcloud.com/api/v1/logradouro/' + uf + '/' + logra).then(function (res) {
                return res;
            });
        };
